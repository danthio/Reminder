...
def det_success():
	...
	try:
		...
		for i in data[str(user)]:
			...
			cur_d=get_cur_date()
			tm_diff=get_time_difference(str(cur_d[0])+"/"+str(cur_d[1])+"/"+str(cur_d[2]),i,2)
...
def main():
	...
	can.create_rectangle(519-1,39-1, 981+1,574+1,outline="#000000",fill="#000000")
	...
	can.create_text(5,h-15,text="Success: "+str(det_success())+" %",font=("FreeMono",13),fill="#ff1f83",anchor="w")
