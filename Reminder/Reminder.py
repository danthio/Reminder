...
im=Image.open("data/trend.png")
im=im.resize((30,30))
im.save("data/trend.png")
...
def main():
	...
	global text
	global user
	global circle2,circle3,circle4,circle5,circle6,circle7
	global can2
	...
	if state2==0:
		...
		can.create_polygon(519-1+10,y, 981+1-10,y, 981+1,y+10, 981+1,y+30-10,
			981+1-10,y+30, 519-1+10,y+30, 519-1,y+30-10, 519-1,y+10,fill="#000000",outline="#000000")


		xx=519-1+((981+1)-(519-1))/2

		can.create_line(xx,y,xx,y+30,fill="#ffffff")
		xx=((981+1)-(519-1))/4
...
circle,circle2,circle3,circle4,circle5,circle6,circle7=0,0,0,0,0,0,0
checked=0
logout=0
show1,show2=0,0
trend=0
def load_im():
	global previous,next_
	global cur_date1,cur_date2
	global circle,circle2,circle3,circle4,circle5,circle6,circle7
	global checked
	global logout
	global show1,show2
